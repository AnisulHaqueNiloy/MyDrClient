        ...
        <div className="px-2 space-y-3 pt-2">
          <div className="flex items-start gap-3 text-white">
            <input 
              ...
              id="terms"
            />
            <label htmlFor="terms" className="text-[15px] leading-tight">
              I accept the terms of the <a href="#" className="underline">regulations</a>
            </label>
          </div>
          <p className="text-white text-[14px] leading-tight opacity-90">
            MyDr processes personal data in accordance with <a href="#" className="underline">privacy policy</a>
          </p>
        </div>

        {/* Buttons */}
        <div className="pt-6 space-y-4">
          <button className="w-full py-4 bg-[#ec4899] hover:bg-pink-600 text-white font-semibold rounded-full shadow-lg transition-all active:scale-95 uppercase tracking-widest text-lg">
            Register
          </button>
          
          <button className="w-full py-4 bg-white hover:bg-gray-100 text-gray-600 font-semibold rounded-full shadow-lg transition-all active:scale-95 uppercase tracking-widest text-lg">
            Go back to login
          </button>
        </div>
